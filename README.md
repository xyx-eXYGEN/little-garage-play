...
**Cache:** open `https://xyx-exygen.github.io/little-garage-play/?v=parent-30` in Safari (hard refresh). Then **delete the Home Screen icon and Add to Home Screen again** so the new JS is not stuck on a cached copy.
